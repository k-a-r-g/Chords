...
const uint8_t TETRADS[10][4][4]  = // A,  B,  C,  O      -- A-C: intervals, O: root note offset 
                                   {{{4,  7,  9,  0},    // major sixth - root                       = minor seventh - 1st inversion
                                    ...
                                    {{3,  7,  9,  0},    // minor sixth - root                       = half-diminished seventh - 1st inversion
                                    ...
                                    {{3,  7, 11,  0},    // minor-major seventh - root
                                    ...
                                    {{4,  8, 11,  0},    // augmented major seventh - root  
                                    ...
                                    {{4,  8, 10,  0},    // augmented minor seventh - root  
                                    ...
                                    {{3,  6,  9,  0},    // diminished seventh - root
                                    ...
                                    {{3,  6, 10,  0},    // half-diminished seventh - root           = minor sixth - 3rd inversion
